          ...
          <div className="relative">
            <div className="w-80 h-80 rounded-full bg-gradient-to-r from-cyan-500 to-green-400 p-1">
              <div className="w-full h-full rounded-full bg-gray-900 flex items-center justify-center">
                <div className="w-72 h-72 rounded-full bg-gradient-to-br from-cyan-500/20 to-green-400/20 flex items-center justify-center text-6xl text-cyan-400 font-bold">
                  LS
                </div>
              </div>
            </div>
